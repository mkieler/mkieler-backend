...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($services as $index => $serviceData) {
            ...
            unset($serviceData['processes'], $serviceData['faqs']);
    ...
    private function getServices(): array
    {
        return [
            [
                'slug' => 'webudvikling',
                'title' => 'Webudvikling',
                'headline' => 'Professionel webudvikling med Laravel og Nuxt',
                'description' => 'Skræddersyede webløsninger bygget med Laravel og Nuxt for optimal performance, sikkerhed og skalerbarhed. Fra simple landingssider til komplekse platforme.',
            ...
            [
                ...
                'headline' => 'Skræddersyede web applikationer til din virksomhed',
                'description' => 'SaaS-platforme, dashboards, kundeportaler og komplekse forretningsapplikationer med real-time funktionalitet og tunge integrationer.',
            ...
            [
                ...
                'headline' => 'Cross-platform apps til iOS og Android',
                'description' => 'Native-lignende mobile apps fra én kodebase med Flutter og React Native. Få din app i hænderne på brugerne hurtigere.',
